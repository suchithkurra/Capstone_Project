...
# Initialize Trusted Authority with randomly set a and b
...
# Try different values for a and b until we find 10 valid pairs
while len(valid_pairs) < 10:
    # Try different random values for a and b
    a = random.randint(1, q - 1)
    b = random.randint(1, q - 1)

    # Update Trusted Authority with new a and b
    ...
    if is_valid:
        ...
        print(f"Message Valid with a = {a}, b = {b}")

# Print all valid pairs of a and b
print("\nAll valid a and b pairs:")
for i, (a, b) in enumerate(valid_pairs, 1):
    print(f"Pair {i}: a = {a}, b = {b}")
